module.exports = {
  run: [
    ...
    // windows nvidia
    {
      ...
      "next": null // Ensure execution stops after this block if the condition matches
    },
    // windows amd
    {
